...
<v-main>
    ...
    <v-spacer></v-spacer>
    <v-container>
      <h1 class="text text-center">Gjakova</h1>
    <p> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est voluptate
      ...
      <v-row no-gutters>
        <v-col cols="12" sm="4" v-for="hotel in hotels" v-bind:key="hotel._id">
          <span v-if="hotel.location == 'Gjakove'">
      ...
      <v-row no-gutters>
        ...
        >
          <span v-if="attraction.location == 'Gjakove'">
            <v-card class="mx-auto" max-width="344">
              <v-img
                height="200px"
...
export default {
  ...
  data() {
    return {
      items: [
        {
          src: require("@/assets/images/gjakova.jpg"),
        ...
        {
          src: require("@/assets/images/img23.jpg"),
          title: "Qarshia"
        },
