...
<v-main>
    ...
    <v-spacer></v-spacer>
    <v-container>
      <h1 class="text text-center">Mitrovica</h1>
    <p> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est voluptate
        ...
        culpa!Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est voluptate
        ullam dolorem quisquam facilis culpa deleniti ipsa fugit architecto
        expedita? Animi ad in rem non! Ut necessitatibus laboriosam possimus
        culpa!Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est voluptate
        ullam dolorem quisquam facilis culpa deleniti ipsa fugit architecto
      ...
      <v-row no-gutters>
        <v-col cols="12" sm="4" v-for="hotel in hotels" v-bind:key="hotel._id">
          <span v-if="hotel.location == 'Mitrovice'">
      ...
      <v-row no-gutters>
        ...
        >
          <span v-if="attraction.location == 'Mitrovice'">
            <v-card class="mx-auto" max-width="344">
              <v-img
                height="200px"
...
export default {
  ...
  data() {
    return {
      items: [
        {
          src: require("@/assets/images/img24.jpg"),
          title: "Divided City of Kosovo"
        },
        {
          src: require("@/assets/images/img25.jpg"),
          title: "Zalli Mosque"
        },
        {
          src: require("@/assets/images/img21.jpg"),
          title: "The Miners Monument"
        },
