<template>
  <v-main>
    ...
    <v-spacer></v-spacer>
    <v-container>
      <h1 class="text text-center">Prishtina</h1>
      <p>
        ...
        culpa!Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est
        voluptate ullam dolorem quisquam facilis culpa deleniti ipsa fugit
        architecto expedita? Animi ad in rem non! Ut necessitatibus laboriosam
        possimus culpa!Lorem ipsum dolor sit, amet consectetur adipisicing elit.
        Est voluptate ullam dolorem quisquam facilis culpa deleniti ipsa fugit
        architecto expedita? Animi ad in rem non! Ut necessitatibus laboriosam
        possimus culpa!Lorem ipsum dolor sit, amet consectetur adipisicing elit.
        Est voluptate ullam dolorem quisquam facilis culpa deleniti ipsa fugit
        architecto expedita? Animi ad in rem non! Ut necessitatibus laboriosam
    ...
    <v-container>
      ...
      <v-row no-gutters>
        ...
        >
          <span v-if="attraction.location == 'Prishtine'">
            <v-card class="mx-auto" max-width="344">
              <v-img
                height="200px"
...
export default {
  ...
  data() {
    return {
      items: [
        {
          src: require("@/assets/images/img16.jpg"),
          title: "Prishtina the Capital City of Kosovo",
        },
        {
          src: require("@/assets/images/img15.jpg"),
          title: "The Great Mosque and the Clock Tower",
        },
        {
          src: require("@/assets/images/img17.jpg"),
          title: "Newborn",
        },
      ],
      hotels: [],
